 ...
 * @author 4L3
 */
public class de_gestionar_recursos_x_programa_editar extends javax.swing.JDialog {
    /**
     * Creates new form ErrorAlert
     */
    public de_gestionar_recursos_x_programa_editar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        addEventKey();
        initComponents();
...
//        String mje2="Por favor introduzca un código distinto de recurso";
        ...
        if (combo_prefabricados_re_editar.getSelectedIndex()==0||cantidad_re_editar.getText().isEmpty()||
            ...
            if(codigo.equals(codigo_re_editar.getText())){
                ...
                paneles_de_paneles.de_gestionar_recursos_x_programa_editar.this.setEnabled(true);
                l.setVisible(false);
                if(control==1){
                    reset_campos();
...
//                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(de_gestionar_recursos_x_programa_editar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                de_gestionar_recursos_x_programa_editar dialog = new de_gestionar_recursos_x_programa_editar(new javax.swing.JFrame(), true);
